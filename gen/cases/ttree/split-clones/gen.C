...
///   ke/fHits/fUniqueID   fType 31          KHit's TObject base, flattened
///   ke/fHits/fBits       fType 31          likewise
...
/// must derive from TObject, and the split gives each of its two members a
/// column of its own.
///
