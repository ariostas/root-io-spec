...
///
/// **Both class versions must be equal.** ROOT refuses otherwise --
/// "version mismatch between SoA type and underlying record type: 7 vs. 3"
/// (root/tree/ntuple/src/RFieldMeta.cxx:707) -- which the specification does not
/// say. They are both 3 here, so the version in the field record cannot say which
/// class it came from; the checksum can, and does.
